...
<body>
    <div class="alert alert-warning d-flex justify-content-center align-items-center text-center" role="alert" style="height: 20px;">
      Check out our latest <a href="{{ route('packs.index') }}" class="alert-link"># packs #</a> before they run out!
    </div>
    <header>
